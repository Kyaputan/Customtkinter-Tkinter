...
def setup_main_window():
    ...
    # Frame E - Top Right
    frame_e = ctk.CTkFrame(top_container, width=300, height=250, fg_color="white", corner_radius=10)
    ...
    frame_g = ctk.CTkFrame(bottom_container, width=300, height=250, fg_color="white", corner_radius=10)
    frame_g.pack(side="left", expand=True, anchor="center", pady=5, padx=5)

    label_g = ctk.CTkLabel(frame_g, text="", image=logo_KMITL_image, width=250, height=240)
