...
def face_recording():
    ...
    exit_bottom = ctk.CTkButton(
        video_frame, text="Exit", fg_color="red", text_color="black"
    )
    ...
    btn_save_b = ctk.CTkButton(
        input_data_frame, text="Save Image", fg_color="#3fd956", text_color="black"
    )
    btn_save_b.pack(padx=10, pady=(10, 5))

    btn_delete_b = ctk.CTkButton(
        input_data_frame, text="Delete Image", fg_color="red", text_color="black"
    )
