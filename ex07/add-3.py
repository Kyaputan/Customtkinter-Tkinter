...
def setup_main_window():
    ...
    # Frame D - Center
    frame_d = ctk.CTkFrame(video_container, width=350, height=320, fg_color="white", corner_radius=10)
    frame_d.pack(side="left", expand=True, anchor="center", pady=(5, 10), padx=(10, 10))

    label_d = ctk.CTkLabel(frame_d, text="", image=logo_KMITL_image, width=300, height=310)
    ...
    # Frame E - Right
    frame_e = ctk.CTkFrame(video_container, width=350, height=320, fg_color="white", corner_radius=10)
    frame_e.pack(side="left", expand=True, anchor="center", pady=(5, 10), padx=(10, 20))

    label_e = ctk.CTkLabel(frame_e, text="", image=logo_KMITL_image, width=300, height=310)
